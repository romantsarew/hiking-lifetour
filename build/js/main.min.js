...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperInitial.swiperIntroTurnOn)();
  (0, _swiperInitial.swiperToursTurnOn)();
  (0, _swiperInitial.swiperTrainersTurnOn)();
  (0, _swiperInitial.swiperOpinionsTurnOn)();
  (0, _swiperInitial.swiperAdvantagesInit)();
  (0, _swiperInitial.swiperPhotoTurnOn)();
  (0, _mapInit.mapInit)();
...
},{"./modules/burger/burger-init":2,"./modules/form-validate/form":4,"./modules/map/map-init":10,"./modules/swiper/swiper-initial":11,"./modules/video/init-video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
exports.swiperAdvantagesInit = swiperAdvantagesInit;
exports.swiperIntroTurnOn = swiperIntroTurnOn;
exports.swiperOpinionsTurnOn = swiperOpinionsTurnOn;
exports.swiperPhotoTurnOn = swiperPhotoTurnOn;
exports.swiperToursTurnOn = swiperToursTurnOn;
exports.swiperTrainersTurnOn = swiperTrainersTurnOn;
var introSlider = document.querySelector('.intro__swiper');
var toursSlider = document.querySelector('.tours__slider');
...
var photoSlider = document.querySelector('.photo__slider');
...
function swiperToursTurnOn() {
  if (toursSlider) {
    // eslint-disable-next-line no-undef, no-unused-vars
    var swiper = new Swiper(toursSlider, {
      initialSlide: 0,
      cssMode: true,
      direction: 'horizontal',
      loop: false,
...
function swiperAdvantagesInit() {
  ...
  function destroyAdvantagesSwiper() {
    if (mySwiper) {
      mySwiper.destroy();
      var advantagesWrapper = advantagesSlider.querySelector('.advantages__wrapper');
...
function setupVideo(video) {
  var link = video.querySelector('.intro__slide-link');
  var button = video.querySelector('.intro__slide-button');
